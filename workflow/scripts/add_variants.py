...
=======
import pysam
>>>>>>> 8d2dddc7b03887552d58c77ff1889c4736003408
...
def get_sequence_from_genome(genome_file, chromosome, start, end):
    # Cette fonction devra lire le fichier FASTA et extraire la séquence ADN de la région spécifiée
...
def modify_transcript(vcf_file, gtf_file, fasta_file, output_file):
    ...
    with open(output_file, 'w') as out:
        # Confirmation initiale que l'écriture dans le fichier fonctionne
