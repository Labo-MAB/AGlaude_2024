...
logging.basicConfig(
    filename="/mnt/f/breast_cancer_new/workflow/results/workflow_errors.log",    # Fichier de log
    level=logging.DEBUG,               # Niveau de log souhaité
...
def main():
    exon_parquet = "/mnt/f/breast_cancer_new/workflow/results/exon_dict.parquet"  
    vcf_file = "/mnt/f/breast_cancer/workflow/results/variants/171992_SIMG0590_T_totalRNA_sarcoma_43378_S9_L002/20QC_variant_tronque.vcf"
    transcripts_fasta = "/mnt/f/breast_cancer/workflow/data/references/transcriptome.fa"
    mutated_output_fasta = "/mnt/f/breast_cancer_new/workflow/results/mutated_transcripts.fasta"
    combined_output_fasta = "/mnt/f/breast_cancer_new/workflow/results/combined_transcripts.fasta"
