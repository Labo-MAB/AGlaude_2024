...
#
    ...
    vcf_file = "data/SRR4787045/10_to_16.vcf"
    transcripts_fasta= "data/SRR4787045/10_to_16_transcripts.fa"
    mutated_output_fa  = "result/SRR45/10_to_16_mutated_transcripts.fa"
    exon_parquet = "data/SRR4787045/exon_data.parquet"
    trees_pkl = "data/SRR4787045/trees.pkl"

# ------------------------------------------------------------
# output Path + constante
# ------------------------------------------------------------
    final_fasta = "result/SRR45/final/10_to_16_transcriptome.fa"
